...
class Institution(models.Model):
    ...
    class Meta:
        db_table = 'assessment_institution'
...
class Department(models.Model):
    ...
    class Meta:
        db_table = 'assessment_department'
...
class AssessmentResult(models.Model):
    ...
    class Meta:
        db_table = 'assessment_assessmentresult'
...
class ChatSession(models.Model):
    ...
    class Meta:
        db_table = 'assessment_chatsession'
...
class ChatMessage(models.Model):
    ...
    class Meta:
        ordering = ['timestamp']
        db_table = 'assessment_chatmessage'
...
class AdminMessage(models.Model):
    ...
    class Meta:
        db_table = 'assessment_adminmessage'
...
class Notification(models.Model):
    ...
    class Meta:
        db_table = 'assessment_notification'
